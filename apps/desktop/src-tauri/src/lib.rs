...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent::agent_start_workflow,
            agent::agent_continue_workflow,
            agent::agent_checkpoint_action,
            agent::agent_cancel_turn,
            agent::agent_set_tool_approval,
            agent::agent_resume_pending_turn,
            agent::agent_reset_tool_approvals,
            ...
            settings::settings_test_provider_connectivity,
