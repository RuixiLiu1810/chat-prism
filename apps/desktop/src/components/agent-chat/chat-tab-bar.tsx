...
export function ChatTabBar() {
  ...
  const setActiveTab = useAgentChatStore((s) => s.setActiveTab);
  const createTab = useAgentChatStore((s) => s.createTab);
  const closeTab = useAgentChatStore((s) => s.closeTab);
